"""=============================================== 
    DETECTION OF ROAD LANE LINE (DETECTING IMAGES) 
   ==============================================="""
...
img = cv2.imread(r"C:\Users\DELL\Downloads\road-lane-detection-master\road-lane-detection-master\Data\test_img.jpg")
